# Instant Search – Turn WordPress Search Into Sales
...
1. Download the plugin from [WordPress.org](https://wordpress.org/plugins/instant-search/)
2. Go to your WordPress dashboard → Plugins → Add New → Upload Plugin
3. Upload the zip, activate, and you're done

Or search for **"Instant Search"** directly in the WordPress plugin directory.
...
## ⚡ Want more? Try Instant Search PRO
...
Made by **Marius-Mugurel Mărincaș** — Web Developer & WordPress Support Lead.

- 🌐 [marincas.net](https://www.marincas.net)
- 🐙 [github.com/webmaster85](https://github.com/webmaster85)
- 📩 contact@marincas.net
